...
Source0  : https://github.com/intel/libva/archive/2.22.0/libva-2.22.0.tar.gz
...
%prep
%setup -q -n libva-2.22.0
cd %{_builddir}/libva-2.22.0
pushd ..
cp -a libva-2.22.0 build32
popd
pushd ..
cp -a libva-2.22.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718917009
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libva-drm.so.2.2200.0
/V3/usr/lib64/libva-glx.so.2.2200.0
/V3/usr/lib64/libva-wayland.so.2.2200.0
/V3/usr/lib64/libva-x11.so.2.2200.0
/V3/usr/lib64/libva.so.2.2200.0
/usr/lib64/libva-drm.so.2
/usr/lib64/libva-drm.so.2.2200.0
/usr/lib64/libva-glx.so.2
/usr/lib64/libva-glx.so.2.2200.0
/usr/lib64/libva-wayland.so.2
/usr/lib64/libva-wayland.so.2.2200.0
...
/usr/lib32/libva-glx.so.2.2200.0
