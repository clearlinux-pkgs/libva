...
Source0  : https://github.com/intel/libva/archive/2.21.0/libva-2.21.0.tar.gz
...
%prep
%setup -q -n libva-2.21.0
cd %{_builddir}/libva-2.21.0
pushd ..
cp -a libva-2.21.0 build32
popd
pushd ..
cp -a libva-2.21.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710252819
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dwith_legacy=nvctrl  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dwith_legacy=nvctrl  builddiravx2
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libva-drm.so.2.2100.0
/V3/usr/lib64/libva-glx.so.2.2100.0
/V3/usr/lib64/libva-wayland.so.2.2100.0
/V3/usr/lib64/libva-x11.so.2.2100.0
/V3/usr/lib64/libva.so.2.2100.0
/usr/lib64/libva-drm.so.2
/usr/lib64/libva-drm.so.2.2100.0
/usr/lib64/libva-glx.so.2
/usr/lib64/libva-glx.so.2.2100.0
/usr/lib64/libva-wayland.so.2
/usr/lib64/libva-wayland.so.2.2100.0
/usr/lib64/libva-x11.so.2
/usr/lib64/libva-x11.so.2.2100.0
/usr/lib64/libva.so.2
/usr/lib64/libva.so.2.2100.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libva-drm.so.2
/usr/lib32/libva-drm.so.2.2100.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.2100.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.2100.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.2100.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.2100.0
