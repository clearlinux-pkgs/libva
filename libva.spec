...
%prep
%setup -q -n libva-2.14.0
cd %{_builddir}/libva-2.14.0
pushd ..
cp -a libva-2.14.0 build32
popd
pushd ..
cp -a libva-2.14.0 buildavx2
popd
...
cp %{_builddir}/libva-2.14.0/COPYING %{buildroot}/usr/share/package-licenses/libva/099b1aff1b937aad419a0cc7cfb474d2d74acf0b
pushd ../build32/
...
/usr/lib32/libva-drm.so.2.1400.0
/usr/lib32/libva-glx.so.2
/usr/lib32/libva-glx.so.2.1400.0
/usr/lib32/libva-wayland.so.2
/usr/lib32/libva-wayland.so.2.1400.0
/usr/lib32/libva-x11.so.2
/usr/lib32/libva-x11.so.2.1400.0
/usr/lib32/libva.so.2
/usr/lib32/libva.so.2.1400.0
